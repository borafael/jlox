...
public class AstGenerator {
	...
	private static final String DEFAULT_OUTPUT_DIR = "/Users/rbarrera/repos/jlox/src/main/java/jlox/interpreter/";

	public static void main(String[] args) throws IOException {
		String outputDir = null;
		
		if (args.length == 0) {
			System.out.println("Using default path: " + DEFAULT_OUTPUT_DIR);
			...
			System.out.println("Usage: AstGenerator [output dir]");
		}

		new AstGenerator().defineAst(outputDir, "Expr",
	...
	private void defineAst(String outputDir, String baseName, List<String> types) throws IOException {
		...
		writer.println("package jlox.interpreter;");
		writer.println();
